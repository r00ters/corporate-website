...
export default function Keypoint() {
 ...
 <section className="keypoint" id="keypoint">
        ...
        <article className="text-first">
            ...
            <img src="/img/monitoring.png" alt="Monitoraggio continuo degli asset" />
        </article>
        ...
        <article className="text-first">
            ...
            <img src="/img/integration.png" alt="Sviluppo tecnologico" />
        </article>
        <article className="image-first">
            <main>
            ...
            <img src="/img/open-source.png" alt="Open Source e trasparenza" />
        </article>
    </section>
  );
}
